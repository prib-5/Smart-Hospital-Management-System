...
export default function HomePage() {
  const [currentStep, setCurrentStep] = useState(BookingStep.CHOOSE_SEARCH_METHOD);
  ...
  const handleSelectSearchMethod = (method) => {
    setBookingData({}); 
  ...
  const handleSubmitPatientInfo = (patientInfo) => {
