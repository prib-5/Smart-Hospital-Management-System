...
import type { Doctor, Department, TimeSlot, BookingData } from '@/types';
...
interface PatientFormProps {
  ...
  date: Date;
  timeSlot: TimeSlot;
  onSubmitPatientInfo: (data: PatientFormData) => void;
  onBack: () => void;
}

export function PatientForm({ department, doctor, date, timeSlot, onSubmitPatientInfo, onBack }: PatientFormProps) {
