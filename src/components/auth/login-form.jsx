...
export function LoginForm({ onAuthSuccess }) {
  ...
  const [formMode, setFormMode] = useState('patientLogin');
  ...
  function onPatientLoginSubmit(data) {
  ...
  async function onDoctorLoginSubmit(data) {
    setIsSubmitting(true);
    try {
