...
import { ArrowLeft, Loader2, Stethoscope, Heart, Brain, Activity, Baby, HelpCircle, type LucideIcon } from 'lucide-react';
...
export function DepartmentSelector({ onSelectDepartment, onBack }: DepartmentSelectorProps) {
